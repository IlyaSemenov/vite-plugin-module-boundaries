# vite-plugin-module-boundaries Agent Guide

## Overview

`vite-plugin-module-boundaries` is a Vite plugin that rejects modules crossing configured filesystem boundaries in selected module graphs.
...
```markdown
---
"vite-plugin-module-boundaries": patch
---
